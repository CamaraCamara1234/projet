...
class Detection:
    def __init__(self):
        caffemodel = os.path.join(
            settings.BASE_DIR, "facial_recognition/face_models/detection_model/Widerface-RetinaFace.caffemodel")
        deploy = os.path.join(
            settings.BASE_DIR, "facial_recognition/face_models/detection_model/deploy.prototxt")
